...
For any questions regarding our data practices or this policy, you can contact us at: SoulMinter Email: [main@soulminter.io](mailto:main@soulminter.io)
...
We use Vercel Analytics and Google Analytics to collect information about how users interact with our Platform. These services help us understand user behavior, identify areas for improvement, and optimize the user experience. Both are designed to be privacy-friendly and primarily collect anonymized data. However, certain technical identifiers or usage patterns collected by these services may, in some jurisdictions, be considered personal data. The data collected includes, but is not limited to, page views, unique visitors, and session duration.

- **Vercel Analytics:** This service does not use traditional cookies for tracking; instead, it relies on privacy-preserving methods to gather insights. Vercel Analytics is only enabled if you consent through our cookie statement. If you opt-out, Vercel Analytics will be disabled.

- **Google Analytics:** This service uses cookies and similar technologies to collect information such as your IP address, browser type, operating system, referring URLs, device information, and how you interact with our Platform. Google Analytics is only enabled if you consent through our cookie statement. If you opt-out, Google Analytics will be disabled.
...
- **To Improve Service Functionality and User Experience:** Aggregated and anonymized usage data, including insights from Vercel Analytics and Google Analytics, helps us understand general platform usage patterns, identify areas for improvement, and enhance functionality and user experience.
...
To exercise any of these rights, or if you have any questions about our data practices, please contact us at [main@soulminter.io](mailto:main@soulminter.io). We will investigate any such claims thoroughly and transparently.
...
- **Analytics:** We use Vercel Analytics and Google Analytics to collect anonymized data about your usage of the Platform. This helps us understand how our Platform is used and allows us to improve it.
  - **Vercel Analytics:** May set cookies or use other privacy-preserving methods. This service is only activated if you provide your consent through our cookie statement. If you choose to opt-out, Vercel Analytics will be disabled.
  - **Google Analytics:** Uses cookies and similar technologies. This service is only activated if you provide your consent through our cookie statement. If you choose to opt-out, Google Analytics will be disabled.
...
By email: [main@soulminter.io](mailto:main@soulminter.io)