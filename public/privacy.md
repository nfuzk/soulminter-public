...
*   **To Manage the Affiliate Program:** We use public wallet addresses and referral data to track referrals and facilitate the direct, on-chain distribution of affiliate commissions, as designed by the Solana program. This process does not involve the processing of personal data by SoulMinter beyond public wallet addresses.
