      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <section>
            ...
            <p>SoulMinter is a technical tool that facilitates the creation, management, and modification of custom tokens on the Solana blockchain. We are not a financial institution, investment advisor, broker, legal counsel, or tax advisor. The content on this Platform, including any descriptions of token functionalities, regulatory summaries, or general market information, is for informational purposes only and does not constitute financial, investment, legal, or tax advice. You should not construe any such information or other material as legal, tax, investment, financial, or other advice. Nothing contained on our Platform constitutes a solicitation, recommendation, endorsement, or offer by SoulMinter or any third-party service provider to buy or sell any crypto-asset or other financial instrument.</p>
          ...
          <section>
            ...
            <ul>
              ...
              <li>All transactions initiated through the Platform—whether for creation or management—are signed and executed directly from your connected wallet.</li>
          ...
          <section>
            ...
            <p>By using SoulMinter to create, manage, or modify tokens (including tokens originally created on other platforms), you acknowledge and agree that you are solely responsible for ensuring that:</p>
            <ul>
              <li>The tokens you create or manage comply with all applicable laws and regulations in all relevant jurisdictions, including but not limited to securities laws, consumer protection laws, and crypto-asset regulations.</li>
              <li>Any subsequent activities related to your tokens, including public offerings, sales, marketing, or distribution, are conducted in full compliance with all legal requirements.</li>
              <li>You have obtained all necessary legal and regulatory advice regarding your token activities.</li>
            </ul>
            <p>SoulMinter does not endorse, validate, or approve the legality or regulatory compliance of any token created or managed on its Platform. Our service is limited to providing the technical means for token interaction.</p>
          </section>
          <section>
